...
def ler_pedidos(arquivo: Path, ids_clientes_validos: set[str]) -> tuple[list[dict[str, Any]], list[dict[str, Any]], int]:
    ...
    return pedidos, itens, removidos_sem_data
    ...
    with Session(engine) as session:
        try:
            ...
            if "pedidos" not in existentes and "pedidos" in arquivos:
                pedidos, itens, removidos_sem_data = ler_pedidos(arquivos["pedidos"], ids_clientes_validos)
